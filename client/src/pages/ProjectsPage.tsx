...
export const ProjectsPage = () => {
  ...
  const [dialog, setDialog] = useState<{ open: boolean; mode: 'create' | 'edit'; project?: Project }>({
    open: false,
    mode: 'create',
  })
  ...
  return (
    <>
      ...
      {!isLoading && (isError || !projects.length) && (
        <EmptyState
          title={t('pages:noProjectsTitle')}
          description={t('pages:noProjectsDescription')}
        />
      )}
      ...
      <ConfirmDialog
        ...
        message={t('pages:projectDeleteMessage', { name: deleteTarget?.name ?? '' })}
